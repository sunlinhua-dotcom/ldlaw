...
| 阶段 | 状态 | 备注 |
|---|---|---|
| P0 工程止血 | T0.1–T0.7 ✅，T0.8 ⬜ | 仅缺统一测试入口 run_all.py |
| P1 知识层 | T1.1 ✅；T1.2 / T1.3 / T1.5 🔶；T1.4 / T1.6 / T1.7 / T1.8 ⬜ | 法规 15 部 719 条但 **verified 全 0**；案例 0、词条 2 |
| P2 检索精度 | T2.1 🔶（二元组替代 jieba）；T2.4 🔶（缺前端 chip）；其余 ⬜ | **评测线 T2.6–T2.8 未动，当前最大缺口** |
...
### T3.3 案例页签 🔶
> **状态注（06-13）**：页签 UI + /api/cases 已上线；数据 0 件，显示空态。筛选需点「筛 选」按钮，建议改为 change 即筛。
- **前置**：T1.6
