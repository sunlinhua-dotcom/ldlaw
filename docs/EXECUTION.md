...
| P1 知识层 | T1.1 / T1.4 ✅；T1.2 / T1.3 / T1.5 / T1.7 🔶；T1.6 / T1.8 ⬜ | 法规 15 部 719 条待 G1；词条 16/32（批次 1 待 G2）；案例 0 |
