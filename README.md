...
| 百科词条 | 16 条 | 批次 1 共 14 条 in_review 待 G2；目标 30 条 |
...
P0 全清；T1.4 核验、T2.7 评测、T1.7 词条批次 1 已就绪。接下来：
检索升级 T2.1（jieba 分词）→ 词条批次 2 补到 30 条 → 案例库 T1.6 →
运营跑 `verify_articles.py --approve`（G1）、律师过 G2/G3 → 评测扩到 100 题（T2.6）。
